...
module.exports = function (pool) {
  ...
  router.put('/:iduser', function (req, res, next) {
    pool.query('UPDATE public.user SET nama=$1, email=$2, password=$3, nohandphone=$4 WHERE iduser=$5', [req.body.nama, req.body.email, req.body.password, req.body.nohandphone, Number(req.params.iduser)], (err, data) => {
      if(err) throw err;
      res.json(data.rows);
    })
  });
